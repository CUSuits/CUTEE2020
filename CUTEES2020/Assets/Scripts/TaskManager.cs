...
{       //datacontroller
    ...
    void Start()
    {
        ...
        jdat2 = "[{\"heart_bpm\":\"64\", \"p_sub\":\"2.47\", \"p_suit\":\"4.00\",\"t_sub\":\"5\",\"v_fan\":\"1448\",\"p_o2\":\"946\",\"rate_o2\":\"1.0\",\"cap_battery\":\"30\",\"p_h2o_g\":\"15\",\"p_h2o_l\":\"16\",\"p_sop\":\"907\",\"rate_sop\":\"1.0\",\"t_battery\":\"3:53:45\",\"t_oxygen\":\"9:23:22\",\"t_water\":\"9:23:22\",\"create_date\":\"2020-02-28T04:45:47.676Z\"}]";
    ...
    IEnumerator GetRequest2(string uri)
    {
        using (UnityWebRequest webRequest = UnityWebRequest.Get(uri))
        {
            ...
            {
                Debug.Log(pages[page] + ": Error: " + webRequest.error);
                jdat2 = File.ReadAllText(Application.dataPath + "/telemetryjson.txt");
                suit_rep = JSON.Parse(jdat2);
            }
            else
            {
